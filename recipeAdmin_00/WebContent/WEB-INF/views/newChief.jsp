				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<c:if test="${fn:contains(author, '회원관리')}">
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a href='newChief'><font size='2' color='white'>셰프 신청
										관리</font></a>
							</nav>
							<nav class="sb-sidenav-menu-nested nav">
									...
									<div class="content-wrap bl">
										...
										<div class="wrapper no-p">
											<ul class="list-group mail-list">
												<li class="list-group-item"><a href="memberDetail">
														<span class="show"> <small class="pull-right">2020.11.22</small>
															<strong class="text-uppercase">나는야</strong>
													</span>
														<p>신청합니다. 셰프등업해주세여~</p>
												</a></li>
												<li class="list-group-item"><a href="memberDetail">
														<span class="show"> <small class="pull-right">2020.11.26</small>
															<strong class="text-uppercase">뮹</strong>
													</span>
														<p>신청합니다. 셰프등업해주세여~.</p>
												</a></li>
												<li class="list-group-item"><a href="memberDetail">
														<span class="show"> <small class="pull-right">2020.11.28</small>
