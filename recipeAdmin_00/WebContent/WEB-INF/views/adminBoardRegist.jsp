...
<!--                             <div class="sb-sidenav-menu-heading">Core</div> -->
                            ...
                            <div class="sb-sidenav-menu-heading">사이트 관리</div>
                            	<nav class="sb-sidenav-menu-nested nav">
									<a href='adminBoardRegist'><font size='2' color='white'>신고된 글 관리</font></a>
                           		</nav>
                           		<nav class="sb-sidenav-menu-nested nav">
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="adminBoardRegist">신고된 글 관리</a></li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                신고된 게시글 목록입니다
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <div float='right'><input type='button' value='선택된 게시물 삭제'></div>
                                </div>
                            </div>
                        </div>
                    </div>
