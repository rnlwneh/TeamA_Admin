...
<!--                                 <a target="_blank" href="https://www.chartjs.org/docs/latest/">Chart.js documentation</a> -->
                        ...
                        <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="" width="100%" border='1' cellspacing="0">
                                        <thead>
                                        	<tr>
                                        		<td>조회 날짜
                                        		<td>
                                        	...
                                        	<tr>
                                        		...
                                        		<td><input type='radio' value='일단위구분' name='123'>일단위구분
                                        			<input type='radio' value='주단위구분' name='123'>주단위구분
                                        			<input type='radio' value='월단위구분' name='123'>월단위구분
                                        	</tr>
                                        </thead>
                                    </table>
                                </div>
