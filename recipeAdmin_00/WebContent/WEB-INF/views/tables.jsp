...
<!--                     </div> -->
            ...
            <div id="layoutSidenav_content">
            	...
            	document.write("<tr><th>번호<th>등급<th>닉네임<th>주소<th>상태<th>상세보기");
            	for(var i=0; i<students.length; i++){
        		    var status1 = new Array('정지', '평온');
            		var rank= new Array('미슐랭셰프', '아임셰프', '내마을요리사', '방구석요리사', '김볶밥가능', '내베프전자레인지');
            	var bgcolor ="white";
				var detail = "상세보기";
            	...
            	document.write("<td>"+(students[i].address));
            	document.write("<td>"+randomItem1(status1));
            	document.write('<td><a href="memberDetail">상세보기</a></td>');
            	}
