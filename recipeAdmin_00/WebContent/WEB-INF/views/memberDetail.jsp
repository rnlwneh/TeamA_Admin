                    ...
                    <div class="col-md-6">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <label>가입연도</label>
                          ...
                          <input class="form-control" type="text" placeholder="2020.01.23" disabled="">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <label>상태</label>
                        <div>
                          <input type="text" class="form-control" name="Nickname" data-parsley-required="true" data-parsley-trigger="change" placeholder="평온">
                        </div>
                      </div>
            ...
            <br>
        			 <div class="col-md-12">
                       <div class="demo-button">
                        <label></label>
                        <div>
                          <button type="button" class="btn btn-danger" style="width:45%;" onclick="location.href='tables'" >정지하기</button> <button  style="width:45%;" type="button" class="btn btn-success"  onclick="location.href='tables'">Save</button>
                        </div>
                      </div>
                    </div>                   
