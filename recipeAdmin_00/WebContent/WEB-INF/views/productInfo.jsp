                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label>상품명</label>
                          ...
                          <input class="form-control" type="text" placeholder="aa1" disabled="">
				...
				<div class="form-group">
 					...
 					<div class="form-group">
                        <label>거래처명</label>
                          ...
                          <input class="form-control" type="text" placeholder="싱싱야채" disabled="">
 					...
 					<div class="col-md-6">
                        ...
                        <label>발주날짜</label>
                          ...
                          <input class="form-control" type="text" placeholder="sysdate" disabled="">
                        ...
                        <label>도착날짜</label>
                          ...
                          <input class="form-control" type="text" placeholder="sysdate+3" disabled="">
                      ...
                      <div class="form-group">
                        <label>수량</label>
                        <div>
                          <input type="text" class="form-control" name="count" data-parsley-required="true" data-parsley-trigger="change" placeholder="-개">
                        </div>
                      </div>
            ...
            <br>
        			 <div class="col-md-12">
                       <div class="demo-button">
                        <label></label>
                        <div>
                          <button type="button" class="btn btn-danger" style="width:45%;" onclick="location.href='orderProduct'" >뒤로가기</button> <button  style="width:45%;" type="button" class="btn btn-success"  onclick="location.href='orderProduct'">Save</button>
                        </div>
                      </div>
                    </div>                   
