...
<!--                     </div> -->
            ...
            <div id="layoutSidenav_content">
            	...
            	for( var i=1; i<=10; i++ ){
            		students.push(		
            			...
            			, s_name: "오찡"+i
            				...
            				,money:Math.ceil( Math.random()*2000)
            			}
            		);
            	}
            	...
            	document.write("<tr><th>번호<th>거래처명<th>거래액<th>발주요일<th>상세보기");
            	for(var i=0; i<students.length; i++){
        
            		var rank= new Array('싱싱과일', '우리농산물', '내마을생선', '여긴바다', '우리집텃밭', '할머니손맛', '집앞냉장고', '이마트', '홈플러스', '농협');
            	var orderDate = new Array('월','화','수','목','금');
            		var bgcolor ="white";
				var detail = "상세보기";
            	...
            	document.write("<td>"+(students[i].money)+"만원");
            	document.write("<td>"+randomItem(orderDate));
               	document.write('<td><a href="clientDetail">상세보기</a></td>');
            	}
